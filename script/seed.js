...
async function seed() {
  ...
  const students = await Promise.all([
    ...
    categoryId: infant.id, age: 1, schoolId:cots4tots.id, groupId: cotsA.id }),
    Student.create({ firstName: 'swoohoop', lastName: 'puckrubs', userId: toespink.id,
    categoryId: toddler.id, age: 2, schoolId:cots4tots.id, groupId: cotsB.id }),
    Student.create({ firstName: 'spydigit', lastName: 'puckrubs', userId: toespink.id,
    categoryId: toddler.id, age: 2, schoolId:cots4tots.id, groupId: cotsB.id }),
    Student.create({ firstName: 'klurchomp', lastName: 'puckrubs', userId: toespink.id,
    categoryId: toddler.id, age: 2, schoolId:cots4tots.id, groupId: cotsB.id }),
