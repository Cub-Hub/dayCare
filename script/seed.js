...
async function seed() {
  ...
  const [olsock, lemon, onion, tums, shward, gumps, widdle, otaco, kimp, bean, qonk, pregut, frobeets, scunchy, cody,
    ...
    User.create({ username: 'olsock', password: '123', typeId: 1, schoolId:cots4tots.id, groupId: cotsA.id, lastName:'beef',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp1.jpeg', email:'olsock@gmail.com', phone:'305-781-2359' }),
    User.create({ username: 'lemon', password: '123', typeId: 1, schoolId:cots4tots.id, groupId: cotsA.id, lastName:'swonky',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp2.jpeg', email:'lemon@gmail.com', phone:'305-932-9572'  }),
    User.create({ username: 'onion', password: '123', typeId: 1, schoolId:cots4tots.id, groupId: cotsB.id, lastName:'doodah',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp3.jpeg', email:'onion@gmail.com', phone:'305-341-2762'  }),
    User.create({ username: 'tums', password: '123', typeId: 1, schoolId:cots4tots.id, groupId: cotsC.id, lastName:'sipsip',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp4.jpeg', email:'tums@gmail.com', phone:'305-320-4321'  }),
    User.create({ username: 'shward', password: '123', typeId: 1, schoolId:cots4tots.id, groupId: cotsD.id, lastName:'pippip',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp5.jpeg', email:'shward@gmail.com', phone:'305-126-6573'  }),
    User.create({ username: 'gumps', password: '123', typeId: 1, schoolId:cots4tots.id, groupId: cotsE.id, lastName:'warky',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp6.jpeg', email:'gumps@gmail.com', phone:'305-130-4187'  }),
    User.create({ username: 'widdle', password: '123', typeId: 1, schoolId:cots4tots.id, groupId: cotsF.id, lastName:'blonk',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp7.jpeg', email:'widdle@gmail.com', phone:'305-961-4356'  }),
    User.create({ username: 'otaco', password: '123', typeId: 1, schoolId:cots4tots.id, groupId: cotsA.id, lastName:'qipso',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp8.jpeg', email:'otaco@gmail.com', phone:'305-396-1942' }),
    User.create({ username: 'kimp', password: '123', typeId: 1, schoolId:lidsNkids.id, groupId: lidsA.id, lastName:'wriggity',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp9.jpeg', email:'kimp@gmail.com', phone:'305-193-4396' }),
    User.create({ username: 'bean', password: '123', typeId: 1, schoolId:lidsNkids.id, groupId: lidsB.id, lastName:'lempepper',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp10.jpeg', email:'bean@gmail.com', phone:'305-341-8912' }),
    User.create({ username: 'qonk', password: '123', typeId: 1, schoolId:lidsNkids.id, groupId: lidsC.id, lastName:'smark',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp11.jpeg', email:'qonk@gmail.com', phone:'305-781-7773' }),
    User.create({ username: 'pregut', password: '123', typeId: 1, schoolId:lidsNkids.id, groupId: lidsD.id, lastName:'flemew',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp12.jpeg', email:'pregut@gmail.com', phone:'305-129-5969' }),
    User.create({ username: 'frobeets', password: '123', typeId: 1, schoolId:lidsNkids.id, groupId: lidsE.id, lastName:'slugug',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp13.jpeg', email:'frobeets@gmail.com', phone:'305-781-9992' }),
    User.create({ username: 'scunchy', password: '123', typeId: 1, schoolId:lidsNkids.id, groupId: lidsF.id, lastName:'spoonish',
    imgURL:'https://cub-hub.s3.us-east-2.amazonaws.com/emp14.jpeg', email:'scunchy@gmail.com', phone:'305-433-3992' }),
