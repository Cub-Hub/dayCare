...
export const Calendar = props => {
  ...
  // Note: Below is based on google quickdocs sample code

  // Client ID and API key from the Developer Console
  var CLIENT_ID = '483108818708-opnjf0jb6sehavlcl6ge1ckqpf5umamg.apps.googleusercontent.com'
  var API_KEY = 'AIzaSyDKu6N31_6OVyblul3Kb3Nx31jLRRKXKRA';
  ...
  function listUpcomingEvents() {
    gapi.client.calendar.events.list({
      //          'calendarId': 'primary',
      'calendarId': 's4vcslf30g91g92qu6f4sqa74c@group.calendar.google.com',
  ...
  var eventOriginal = {
    ...
    'start': {
      'dateTime': '2021-09-04T09:00:00-07:00',
