    ...
    return (
      ...
      <div id='calendarDashboard'>
        ...
        <div className='block'>
          ...
          <input value={this.state.summary} onChange={(e) => {
            console.log(e.target.value);
            this.setState({ summary: e.target.value })
          }}></input><br />

          <select value={this.state.month} onChange={(e) => {
            console.log(e.target.value);
          ...
          <select value={this.state.day1} onChange={(e) => {
            console.log(e.target.value);
          ...
          <select value={this.state.year} onChange={(e) => {
            console.log(e.target.value);
          ...
          <br></br>
          {" "}H{" "}
          <select value={this.state.startHour} onChange={(e) => {
            console.log(e.target.value);
          ...
          {" "}M{" "}
          <select value={this.state.startMinute} onChange={(e) => {
            console.log(e.target.value);
          ...
          <br></br>
          {" "}H{" "}
          <select value={this.state.endHour} onChange={(e) => {
            console.log(e.target.value);
          ...
          <select value={this.state.endMinute} onChange={(e) => {
            console.log(e.target.value);
